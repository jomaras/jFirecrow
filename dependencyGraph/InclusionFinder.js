(function()
{
    ...
    var InclusionFinder;
    Firecrow.N_DependencyGraph.InclusionFinder = InclusionFinder = function(){};

    InclusionFinder.notifyError = function(message) { alert("InclusionFinder - " + message);}

    InclusionFinder.prototype =
    {
